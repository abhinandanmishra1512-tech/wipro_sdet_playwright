...
const AbhinandanAccount = new BankAccount();
AbhinandanAccount.deposit(1000);
AbhinandanAccount.withdraw(200);
// AbhinandanAccount.balance = 10000;
console.log(`Final Balance: ₹${AbhinandanAccount.getBalance()}`);
 
const RahulAccount = new BankAccount();
RahulAccount.deposit(500);
RahulAccount.withdraw(1000);
console.log(`Final Balance: ₹${RahulAccount.getBalance()}`);
